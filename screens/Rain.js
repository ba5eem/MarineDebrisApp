...
import erlich from '../assets/images/heart.png';
import moneyFront from '../assets/images/heart.png';
import moneyBack from '../assets/images/heart.png';
        ...
        >
          <Swinging amplitude={MONEY_DIMENSIONS.width / 5} delay={randomize(duration)}>
            ...
            <FlippingImage
              ...
              delay={flipDelay}
              back
              style={{ zIndex: 10000, position: 'absolute', width: 30, height: 30 }}
            />
          </Swinging>
        </Falling>
      ))}
